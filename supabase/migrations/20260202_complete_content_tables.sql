...
('Career Services Team', 'Career Counselors', 'staff', 'Our career services team provides comprehensive support including resume writing, interview preparation, job search assistance, and direct connections to hiring employers. We are dedicated to helping every graduate find meaningful employment.', '/images/team/career-services.jpg', 3, true, NULL),
('Student Support Team', 'Enrollment Advisors', 'staff', 'Our enrollment advisors guide students through the application process, help navigate funding options, and provide ongoing support throughout their training journey. We make the path to a new career as smooth as possible.', '/images/team/student-support.jpg', 4, true, NULL),
('Administrative Team', 'Operations & Compliance', 'admin', 'Our administrative team ensures smooth operations, maintains compliance with all regulatory requirements, and supports the infrastructure that makes our programs possible.', '/images/team/admin-team.jpg', 5, true, NULL)
ON CONFLICT DO NOTHING;
