...
export function AutoProgramGenerator() {
  ...
  const [selectedProgram, setSelectedProgram] =
    useState<AutoGeneratedProgram | null>(null);
  ...
  const loadExistingPrograms = async () => {
    // Simulate loading existing au programs
      ...
      modules: [
        {
          ...
          description:
            'Understanding 5G technology, architecture, and implementation',
          duration: '3 weeks',
          learningObjectives: [
          ...
          practicalLabs: [
            {
              ...
              type: 'simulation',
              description:
                'Simulate 5G network deployment in urban environment',
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-brand-text-muted">
            AI-powered creation and nationwide deployment of network training
            programs
          </p>
        </div>
        <button
          ...
          <div key={program.id} className="bg-white border rounded-lg p-6">
            <div className="flex items-start justify-between mb-4">
              <div className="flex-1">
                <div className="flex items-center mb-2">
                  <h3 className="text-lg font-semibold text-brand-text mr-3">
                    {program.title}
                  </h3>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span
                    className={`font-bold ${getDemandColor(program.demandScore)}`}
                  >
                    {program.demandScore}%
                  </span>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
              <div className="bg-brand-surface rounded p-3">
                ...
                <div className="text-xs text-brand-text-light">
                  {program.nationalAvailability.availableStates
                    .slice(0, 5)
                    .join(', ')}
            ...
            {program.nationalAvailability.expansionPlan.length > 0 && (
              <div className="mt-4 bg-yellow-50 border border-yellow-200 rounded p-3">
                ...
                {program.nationalAvailability.expansionPlan.map(
                  (plan, index) => (
                    <div key={index} className="text-xs text-yellow-700 mb-1">
                      🎯 {plan.state} - Target: {plan.targetDate} - Capacity:{' '}
                      {plan.estimatedCapacity} students
                    </div>
                  )
                )}
              </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                {selectedProgram.modules.map((module, index) => (
                  <div
                    key={index}
                    className="bg-brand-surface rounded p-3 mb-2"
                  >
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    States:{' '}
                    {selectedProgram.nationalAvailability.availableStates.join(
                      ', '
                    )}
                  </div>
                  <div>
                    Partners:{' '}
                    {selectedProgram.nationalAvailability.partnerInstitutions}
                  </div>
                  <div>
                    Capacity:{' '}
                    {selectedProgram.nationalAvailability.totalCapacity}
                  </div>
                  <div>
                    Enrolled:{' '}
                    {selectedProgram.nationalAvailability.currentEnrollment}
                  </div>
                </div>
              </div>
            </div>
