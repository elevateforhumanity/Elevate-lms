...
import { 
  ...
  Award, Circle, AlertCircle, Loader2, Share2,
    ...
    <div className="min-h-screen bg-slate-900 pb-20">
      <header className="bg-slate-700 px-4 pt-12 pb-6 safe-area-inset-top">
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center">
          <p className="text-purple-200 text-sm mb-1">Hours This Week</p>
        ...
        <div className="bg-slate-800 rounded-xl p-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4 text-center">
              <Circle className="w-6 h-6 text-green-400 mx-auto mb-2" />
        ...
        <div className="bg-purple-500/20 border border-purple-500/30 rounded-xl p-4">
          ...
          <div className="flex items-end justify-between mb-3">
            <div>
              ...
              <p className="text-purple-200 text-sm">of 2,000 hours</p>
            </div>
