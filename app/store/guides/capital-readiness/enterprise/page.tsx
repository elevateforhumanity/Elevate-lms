...
import { ArrowLeft, Building2, Shield, Globe, Users, FileCheck, Scale, Briefcase, Circle, AlertTriangle, Clock, DollarSign } from "lucide-react";
                ...
                <ul className="space-y-2 mb-4">
                  {stakeholder.responsibilities.map((resp, j) => (
                    <li key={j} className="flex items-start gap-2 text-gray-300 text-sm">
                      <Circle className="w-4 h-4 text-cyan-400 flex-shrink-0 mt-0.5" />
                      {resp}
                    </li>
                  ))}
                </ul>
