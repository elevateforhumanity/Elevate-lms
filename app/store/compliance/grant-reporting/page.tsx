  ...
  return (
    <div className="bg-white">
      ...
      <AvatarGuide
        ...
        avatarName="Graduate"
        welcomeMessage="Hey! I'm Graduate. I used to spend 40 hours on quarterly reports. Now it takes 10 minutes. Let me show you how our grant reporting tools work."
        steps={guideSteps}
        autoStart={true}
      />
      ...
      <section className="relative text-white py-20 overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/images/heroes-hq/funding-hero.jpg" alt="Grant Reporting" fill className="object-cover" />
        </div>
