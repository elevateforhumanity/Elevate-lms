...
export default function BarberOrientationPage() {
      ...
      content: (
        <div className="space-y-4">
          ...
          <ul className="space-y-2">
            ...
            <li className="flex items-start gap-2">
              <Circle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
              <span>Work legally as a licensed barber in the state of Indiana</span>
            </li>
            <li className="flex items-start gap-2">
              <Circle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-3">
            ...
            <li className="flex items-start gap-2">
              ...
              <span><strong>Maintain professionalism.</strong> You represent the shop and the program. Dress code and conduct standards apply.</span>
            </li>
            <li className="flex items-start gap-2">
  ...
  const handleComplete = async () => {
    ...
    try {
      // Mark orientation as complete in the database
      ...
      if (response.ok) {
        ...
        // Still redirect even if API fails - we'll catch it on the documents page
        router.push('/programs/barber-apprenticeship/documents');
      }
    } catch {
      router.push('/programs/barber-apprenticeship/documents');
    ...
    <div className="min-h-screen bg-slate-100">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          {/* Acknowledgment Checkbox (only on last section) */}
          {isLastSection && (
