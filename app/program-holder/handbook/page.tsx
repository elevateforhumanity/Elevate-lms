...
import { AlertTriangle, BookOpen, Circle } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="prose prose-slate max-w-none mb-12">
          ...
          <div className="mt-4 p-4 bg-green-50 border-l-4 border-green-400">
            <p className="font-semibold text-green-900">
              <Circle className="w-5 h-5 inline-block" /> Approval Process:
            </p>
        ...
        <div className="bg-slate-50 rounded-xl p-8 border-2 border-slate-200">
          <div className="flex items-start gap-4 mb-6">
            <Circle className="text-green-600 flex-shrink-0" size={32} />
            <div>
