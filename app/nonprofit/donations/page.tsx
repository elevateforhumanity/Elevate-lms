            ...
            {displayTiers.map((tier: any, index: number) => {
              ...
              return (
                <div key={index} className="bg-white rounded-xl p-6 text-center shadow-sm hover:shadow-md transition">
                  ...
                  <p className="text-purple-600 font-medium mb-2">{tier.title}</p>
            ...
            <div className="space-y-4">
              {recentDonors.map((donor: any, index: number) => (
                <div key={index} className="bg-white rounded-lg p-4 flex items-center justify-between">
                  ...
                  <span className="text-purple-600 font-semibold">${donor.amount}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="py-16 px-4 bg-purple-600 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link
            href="https://donate.stripe.com/5kA5kn7EsfrD08w4gg"
            target="_blank"
            className="inline-block bg-white text-purple-600 px-12 py-4 rounded-lg text-lg font-bold hover:bg-gray-100 transition"
          >
            Donate Now
          </Link>
        </div>
