...
import { Zap, Rocket, Target, TrendingUp, Clock, Award, ArrowRight, Circle,
  Phone
} from 'lucide-react';
            ...
            <div key={index} className="bg-gray-800 rounded-xl p-6 border border-gray-700 hover:border-blue-500 transition-colors">
              ...
              <ul className="space-y-2 mb-6">
                <li className="flex items-center gap-2 text-gray-300 text-sm">
                  <Circle className="w-4 h-4 text-green-400" /> Full curriculum coverage
                </li>
                <li className="flex items-center gap-2 text-gray-300 text-sm">
                  <Circle className="w-4 h-4 text-green-400" /> Hands-on training included
                </li>
                <li className="flex items-center gap-2 text-gray-300 text-sm">
                  <Circle className="w-4 h-4 text-green-400" /> Job placement assistance
                </li>
              </ul>
