      ...
      <section className="py-8 bg-gray-50 border-b">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-wrap justify-center items-center gap-8">
            ...
            <div className="flex items-center">
              <Circle className="w-8 h-8 text-green-600 mr-2" />
            ...
            <div className="bg-white border-2 border-blue-200 rounded-lg p-8 hover:shadow-xl transition-all">
              ...
              <ul className="space-y-3 mb-6">
                <li className="flex items-start">
                  <Circle className="w-5 h-5 text-green-600 mr-2 flex-shrink-0 mt-1" />
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-8">
            ...
            <div className="grid md:grid-cols-3 gap-6 text-center">
              ...
              <div>
                <Circle className="w-12 h-12 text-green-600 mx-auto mb-2" />
