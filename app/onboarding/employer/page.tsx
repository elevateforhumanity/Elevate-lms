...
import { Circle, Clock, FileText, Building, Briefcase } from 'lucide-react';
...
const steps = [
  ...
  { title: 'Start Hiring', description: 'Connect with qualified candidates', icon: Circle, status: 'pending' },
];
