...
import { Zap, Database, Mail, Award, Calendar, ArrowRight, Circle, AlertCircle, ArrowRightLeft } from 'lucide-react';
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="w-32 bg-slate-100 text-slate-700 px-4 py-2 rounded-lg text-center text-sm font-medium">
                    Salesforce
                  </div>
                </div>
