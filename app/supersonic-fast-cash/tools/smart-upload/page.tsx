                    ...
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <div className="flex items-center gap-2">
                        {file.status === 'uploading' && (
                          <span className="flex items-center gap-2 px-3 py-2 bg-blue-100 text-blue-700 rounded-full text-sm font-semibold">
                            <Loader2 className="w-4 h-4 animate-spin" />
                            Uploading
                          </span>
                        )}
                        {file.status === 'processing' && (
                          <span className="flex items-center gap-2 px-3 py-2 bg-purple-100 text-purple-700 rounded-full text-sm font-semibold">
